...
function(input, output) {
  ...
  col_explanations <- list(
        ...
        significant_test = "'Yes'1 if the result of the performed statistical test was significant, 'No' otherwise. None if not applicable (e.g., if no statistical tests were performed). Unknown if a test was performed but its significance was not stated. None if no statistical tests were performed.",
        ...
        study_category = "Only resting-state data, only task-based data, or both types of data analysed in the study.",
        ...
        cfa_use_minimal_artifact_window = "Did the authors limit the analyses to a specific time range specifically to avoid the CFA?",
        ...
        window_type_category = "In the study, were only primary analyses performed or primary and secondary (both). See also 'hep_window_type' for explanation",
        ...
        Journal = "Journal name as exported without any modifications",
