shiny_config <- list(
  ...
  "column_tooltips" = list(
    ...
    age_mean = "Average age across participant groups, in years.",
    age_min = "Minimum age across participant groups, in years.",
    age_max = "Maximum age across participant groups, in years.",
    age_group = "Matching of average age to different age-groups: < 1 = Infants, >= 1  & < 12  = Children, >= 12 & < 18  = Adolescents, >= 18 = Adults",
    ...
    ecg_high_pass = "If specified, the cutoff frequency of the high-pass filter that was applied to the ECG data, in Hz.",
    ecg_low_pass = "If specified, the cutoff frequency of the low-pass filter that was applied to the ECG data, in Hz.",
    ...
    reference_offline = "The reference that was used during the analysis of the EEG data.",
    ...
    significant_test = "'Yes' if the result of the performed statistical test was significant, 'No' otherwise. None if not applicable (e.g., if no statistical tests were performed). Unknown if a test was performed but its significance was not stated.",
    ...
    trials_Mean = "Average number of trials used for HER analysis across participants. Contains estimated trial counts. See also 'trial_estimation' column for details on estimation procedure.",
    trials_SD = "Standard deviation of number of trials used for HER analysis across participants",
